...
| **Jellyfin.MeiamSub.SubtitleCat** | Jellyfin | .NET 9.0 | SubtitleCat 字幕插件 (支持 100+ 语言) |
...
3. 在“目录”中找到以下插件并按需安装，重启服务即可：
   - **MeiamSub.Thunder** — 迅雷看看字幕源 (仅中文)
   - **MeiamSub.Shooter** — 射手影音字幕源 (中文/英文)
   - **MeiamSub.SubtitleCat** — SubtitleCat 字幕源 (支持 100+ 语言，基于 [subtitlecat.com](https://subtitlecat.com))
